...
neighborhood.set('portrait_bedroom', [ 'portrait_bedroom', 'snitch_bedroom', 'willow_bedroom', 'hallway' ]);
neighborhood.set('willow_bedroom', [ 'portrait_bedroom', 'willow_bedroom', 'hallway' ]);
neighborhood.set('snitch_bedroom', [ 'portrait_bedroom', 'hallway' ]);
neighborhood.set('hallway', [ 'living_room', 'portrait_bedroom', 'snitch_bedroom', 'willow_bedroom', 'hallway' ]);
