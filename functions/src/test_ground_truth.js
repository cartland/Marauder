...
neighborhood.set('nick_bedroom', [ 'nick_bedroom', 'cartland_bedroom', 'stromme_bedroom', 'hallway' ]);
neighborhood.set('stromme_bedroom', [ 'nick_bedroom', 'stromme_bedroom', 'hallway' ]);
neighborhood.set('cartland_bedroom', [ 'nick_bedroom', 'hallway' ]);
neighborhood.set('hallway', [ 'living_room', 'nick_bedroom', 'cartland_bedroom', 'stromme_bedroom', 'hallway' ]);
