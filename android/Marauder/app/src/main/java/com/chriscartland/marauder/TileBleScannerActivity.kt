...
class TileBleScannerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tile_ble_scanner)
    ...
    companion object {
        private val TAG = TileBleScannerActivity::class.java.simpleName
